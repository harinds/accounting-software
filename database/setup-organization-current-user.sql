-- Create organization for the currently logged in user
-- Run this SQL in Supabase SQL Editor

DO $$
DECLARE
  org_id UUID := 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11';  -- Fixed UUID for consistency
  target_email TEXT := 'localhost.gave777@passinbox.com';  -- Your current logged-in email
BEGIN
  ...
  -- Create organization (will skip if already exists)
  ...
  -- Link the current user to the organization
